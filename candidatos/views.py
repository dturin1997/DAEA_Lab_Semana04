...
def listado(request, region_id):
    ...
    return render(request, 'candidatos/listado.html', context)

def detalle(request, region_id, candidato_id):
    region=get_object_or_404(Region, pk=region_id)
    ...
    return render(request, 'candidatos/detalle.html', context)